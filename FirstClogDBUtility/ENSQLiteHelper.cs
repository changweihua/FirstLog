...
namespace FirstClogDBUtility
{
   ...
   *************************************************************************************/
    ...
    /// 添加类描述
    /// </summary>
    public class ENSQLiteHelper
    {
        /// <summary>
        /// Creates a new <see cref="ENSQLiteHelper"/> instance. The ctor is marked private since all members are static.
        /// </summary>
        private ENSQLiteHelper()
        {
        }
        /// <summary>
        /// Creates the command.
